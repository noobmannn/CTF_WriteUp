...
Đây là các cấu trúc lệnh assembly mô phỏng 1 vòng của hàm mã hoá AES, có thể tham khảo kĩ hơn ở [đây](https://www.intel.com/content/www/us/en/developer/articles/technical/advanced-encryption-standard-instructions-aes-ni.html) và [đây](https://en.wikipedia.org/wiki/AES_instruction_set)

Code dựng lại bằng Python

``aesenc`` và ``aesenclast``:
